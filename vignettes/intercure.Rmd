...
The times to events are obtained with the conditional distribution of $T$ given the interval censoring and all the augmented data, using the Nelson-Aalen estimator to obtain the cumulative hazard. The algorithm steps and a full description of the model are given on @lam2013.
...
```{r, echo = FALSE}
set.seed(3)
pander::pander(sim_frailty_cl(15, nclus = 3))
```
...
```{r, message = FALSE, warning = FALSE, results = 'hide', cache = TRUE}
# hypothetical interval censored dataset with a cure fraction
cureset <- sim_frailty_cl(150, nclus = 3)
