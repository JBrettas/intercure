#' Generates a interval censored dataset using the frailty cure rate model
#'
#' \code{sim_frailty} returns a dataset generated by the frailty cure rate
#' model.
...
#' @param B A positive number which multiplies an exponential random variable with mean 1,
...
#'   with value 0 for cured individuals.
#' @examples
#' sim_frailty(20)
#' @export
sim_frailty <- function(N, theta = c(-1,1,0),
  ...
  dados <- data.frame(Z, L, R, delta, xi1, xi2, U = U_vector)
  return(dados)
}
