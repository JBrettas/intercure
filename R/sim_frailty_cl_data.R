#' Generates a interval censored clustered dataset using the frailty cure rate model
#'
#' \code{sim_frailty_cl} returns a dataset generated by the cure rate frailty
