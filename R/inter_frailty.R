...
#' Generates a dataset based on frailty cure rate model .
#'
...
#' @param B A positive number which multiplies an uniform random variable, defining another right censoring case.
#' @param prob Probability that individual presents treatment T1 (baseline is T0).
#' @return A generated dataset with columns: \code{Z}, the actual event time; \code{L}, the leftmost limit of the censored interval;
#' \code{R}, the rightmost limit of the censored interval; \code{delta}, the failure indicator; \code{x1}, the treatment covariate assuming
#' 1 with probability \code{prob} and 0 otherwise; \code{xi2}, second variable generated by a standard normal distribution.
#' @examples
#' sim_frailty_data(20)
